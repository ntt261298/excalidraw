!(function () {
                    ...
                    try {
                      for (var l = i(s), c = l.next(); !c.done; c = l.next()) {
                        var h = c.value,
                          ...
                          p = u.f ? ' TEX-' + u.f : '',
                          d = u.unknown
                            ? this.jax.unknownText(String.fromCodePoint(h), n)
            ...
            return (
              ...
              (e.styles = {
                ...
                'mjx-menclose > dbox': {
                  ...
                  'border-radius': '50%',
                  'clip-path':
                    'inset(0 0 0 ' + (0, f.em)(1.5 * p.PADDING) + ')',
                  'box-sizing': 'border-box',
                },
              }),
              (e.notations = new Map([
                ...
                [
                  'circle',
                  { renderer: p.RenderElement('cbox'), bbox: p.fullBBox },
                ],
                [
                  'phasorangle',
                  {
            ...
            return (
              ...
              (e.prototype.toCHTML = function (t) {
                ...
                if ((this.childNodes[0].toCHTML(e), r.numScripts)) {
                  ...
                  'left' !== s &&
                    this.adaptor.setAttribute(f, 'script-align', s);
                }
              }),
              ...
              (e.prototype.handleColumnSpacing = function () {
                ...
                try {
                  for (
                    ...
                    try {
                      for (
                        var p = ((r = void 0), i(h.tableCells)), d = p.next();
                        !d.done;
                        d = p.next()
                      ) {
                        var f = d.value,
                      ...
                      if ('none' !== h)
                        try {
                          for (
                            var u =
                                ((r = void 0),
                                i(this.adaptor.childNodes(c.chtml))),
                              p = u.next();
                            !p.done;
                            p = u.next()
                          ) {
              ...
              (e.prototype.getMetricMaps = function (t) {
                ...
                try {
                  for (
                    ...
                    try {
                      for (
                        var j = ((i = void 0), s(f[w].keys())), C = j.next();
                        !C.done;
                        C = j.next()
                      ) {
                        var O = C.value;
                ...
                try {
                  for (
                    ...
                    try {
                      for (
                        var B = ((u = void 0), s(f[w].values())), L = B.next();
                        !L.done;
                        L = B.next()
                      ) {
                        O = L.value;
  ...
  (ft.n = function (t) {
    ...
    (ut = ft(3191)),
    MathJax.loader &&
      MathJax.loader.checkVersion('output/chtml', e.q, 'output'),
    (0, t.r8)({
      _: {
        output: {
          chtml_ts: r,
